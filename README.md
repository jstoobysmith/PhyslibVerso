...
- **Home-page "help wanted".** The landing page carries an *"you can edit this
  wiki"* callout and a **Pages that could use more documentation** table, ranked
  by declarations per docstring character (lots of formalized results, little
  prose). The table is generated by [`scripts/edit-candidates.mjs`](./scripts/edit-candidates.mjs)
  (from `roadmap-data.json`) into `edit-candidates.json` at the site root, which
  `install-roadmap.mjs` produces during the build.
